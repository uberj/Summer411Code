/*
 * mpiMulti: Matrix-Matrix Multiplication using row-wise splitting
 * Uses MPI for parallelization
 *
 * June 24, 2011 - Kevin Strasser
 */
...
int main(int argc, char *argv[]) {
    	int n = 0, p, n_ubound, n_local, n_sq, i;
